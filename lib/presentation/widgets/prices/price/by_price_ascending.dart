...
class ByPriceAscending extends StatelessWidget {
  final int index;
  ByPriceAscending({this.index});
    ...
    return BlocBuilder<AssetsCubit, AssetsState>(
      ...
      builder: (context, state) {
        if (state is AssetsSortedByPriceAscending) {
          ...
          final sortedByPriceAscending = assetClass.sortedByNum((element) => double.parse(element.priceUsd));
          final asset = sortedByPriceAscending[index];
