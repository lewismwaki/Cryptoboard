...
class ByPriceDescending extends StatelessWidget {
  final int index;
  ByPriceDescending({this.index});
    ...
    return BlocBuilder<AssetsCubit, AssetsState>(
      ...
      builder: (context, state) {
        if (state is AssetsSortedByPriceDescending) {
          ...
          final sortedByPriceDescending = assetClass.sortedByNum((element) => double.parse(element.priceUsd)).reversed.toList();
          final reversedAsset = sortedByPriceDescending[index];
