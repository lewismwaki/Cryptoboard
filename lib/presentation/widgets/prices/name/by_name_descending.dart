...
class ByNameDescending extends StatelessWidget {
  final int index;
  ByNameDescending({this.index});
    ...
    return BlocBuilder<AssetsCubit, AssetsState>(
      ...
      builder: (context, state) {
        if (state is AssetsSortedByNameDescending) {
          ...
          final sortedByNameDescending = assetClass.sortedByString((element) => (element.name)).reversed.toList();
          final reversedAsset = sortedByNameDescending[index];
