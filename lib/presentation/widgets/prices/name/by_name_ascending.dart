...
class ByNameAscending extends StatelessWidget {
  final int index;
  ByNameAscending({this.index});
    ...
    return BlocBuilder<AssetsCubit, AssetsState>(
      ...
      builder: (context, state) {
        if (state is AssetsSortedByNameAscending) {
          ...
          final sortedByNameAscending = assetClass.sortedByString((element) => (element.name));
          final asset = sortedByNameAscending[index];
