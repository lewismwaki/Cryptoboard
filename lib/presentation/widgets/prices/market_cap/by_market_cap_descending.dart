...
class ByMarketCapDescending extends StatelessWidget {
  final int index;
  ByMarketCapDescending({this.index});
    ...
    return BlocBuilder<AssetsCubit, AssetsState>(
      ...
      builder: (context, state) {
        if (state is AssetsSortedByMarketCapDescending) {
          ...
          final sortedByMarketCapAscending = assetClass.sortedByNum((element) => double.parse(element.marketCapUsd)).reversed.toList();
          final reversedAsset = sortedByMarketCapAscending[index];
