...
class ByMarketCapAscending extends StatelessWidget {
  final int index;
  ByMarketCapAscending({this.index});
    ...
    return BlocBuilder<AssetsCubit, AssetsState>(
      ...
      builder: (context, state) {
        if (state is AssetsSortedByMarketCapAscending) {
          ...
          final sortedByMarketCapAscending = assetClass.sortedByNum((element) => double.parse(element.marketCapUsd));
          final asset = sortedByMarketCapAscending[index];
