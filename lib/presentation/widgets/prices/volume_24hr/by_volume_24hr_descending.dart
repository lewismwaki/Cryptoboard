...
class ByVolume24hrDescending extends StatelessWidget {
  final int index;
  ByVolume24hrDescending({this.index});
    ...
    return BlocBuilder<AssetsCubit, AssetsState>(
      ...
      builder: (context, state) {
        if (state is AssetsSortedByVolume24hrDescending) {
          ...
          final sortedByVolume24hrDescending = assetClass.sortedByNum((element) => double.parse(element.volumeUsd24Hr)).reversed.toList();
          final reversedAsset = sortedByVolume24hrDescending[index];
