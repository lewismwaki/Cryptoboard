...
class ByVolume24hrAscending extends StatelessWidget {
  final int index;
  ByVolume24hrAscending({this.index});
    ...
    return BlocBuilder<AssetsCubit, AssetsState>(
      ...
      builder: (context, state) {
        if (state is AssetsSortedByVolume24hrAscending) {
          ...
          final sortedByVolume24hrAscending = assetClass.sortedByNum((element) => double.parse(element.volumeUsd24Hr));
          final asset = sortedByVolume24hrAscending[index];
