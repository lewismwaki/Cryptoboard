...
class ByPercentageChangeDescending extends StatelessWidget {
  final int index;
  ByPercentageChangeDescending({this.index});
    ...
    return BlocBuilder<AssetsCubit, AssetsState>(
      ...
      builder: (context, state) {
        if (state is AssetsSortedByPercentageChangeDescending) {
          ...
          final sortedByPercentageChangeDescending = assetClass.sortedByNum((element) => double.parse(element.changePercent24Hr)).reversed.toList();
