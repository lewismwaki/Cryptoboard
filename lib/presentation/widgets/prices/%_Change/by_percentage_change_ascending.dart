...
class ByPercentageChangeAscending extends StatelessWidget {
  final int index;
  ByPercentageChangeAscending({this.index});
    ...
    return BlocBuilder<AssetsCubit, AssetsState>(
      ...
      builder: (context, state) {
        if (state is AssetsSortedByPercentageChangeAscending) {
          ...
          final sortedByPercentageChangeAscending = assetClass.sortedByNum((element) => double.parse(element.changePercent24Hr));
          final asset = sortedByPercentageChangeAscending[index];
