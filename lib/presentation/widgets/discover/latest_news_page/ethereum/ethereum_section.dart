...
import 'package:cryptoboard/presentation/pages/coin_news/ethereum_coin_news.dart';
...
class EthereumSection extends StatefulWidget {
  @override
  _EthereumSectionState createState() => _EthereumSectionState();
}
                ...
                Container(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      if (index <= 2) {
                        final news = state.ethereumNews.data[index];
                      ...
                      Navigator.of(context).push(
                        MaterialPageRoute(
                          builder: (BuildContext context) {
                            return EthereumCoinNews(newsBloc: newsBloc);
                          },
                        ),
                      );
                    },
