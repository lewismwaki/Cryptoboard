...
class RippleCoinNews extends StatelessWidget {
  final NewsBloc newsBloc;

  const RippleCoinNews({Key key, this.newsBloc}) : super(key: key);
  @override
        ...
        return Scaffold(
          ...
          appBar: AppBar(
            ...
            title: Column(
              ...
              children: [
                Text('Ripple', style: appBarText.copyWith(fontSize: 17.sp)),
