...
class EthereumCoinNews extends StatefulWidget {
  final NewsBloc newsBloc;

  const EthereumCoinNews({Key key, this.newsBloc}) : super(key: key);

  @override
  _EthereumCoinNewsState createState() => _EthereumCoinNewsState();
}
        ...
        return Scaffold(
          ...
          appBar: AppBar(
            ...
            title: Column(
              ...
              children: [
                Text('Ethereum', style: appBarText.copyWith(fontSize: 17.sp)),
