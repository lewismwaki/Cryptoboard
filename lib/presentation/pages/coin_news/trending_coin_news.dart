...
class TrendingCoinNews extends StatefulWidget {
  final NewsBloc newsBloc;

  const TrendingCoinNews({Key key, this.newsBloc}) : super(key: key);

  @override
  _TrendingCoinNewsState createState() => _TrendingCoinNewsState();
}
        ...
        return Scaffold(
          ...
          appBar: AppBar(
            ...
            title: Column(
              ...
              children: [
                Text('Trending', style: appBarText.copyWith(fontSize: 17.sp)),
